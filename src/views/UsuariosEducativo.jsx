// src/views/UsuariosEducativo.jsx
...
const UsuariosEducativo = ({ onBack }) => {
    ...
    <div style={container}>
      ...
      <div style={header}>
        ...
        <div>
          ...
          <p style={subtitle}>
            Usuarios educativos registrados
...
export default UsuariosEducativo;